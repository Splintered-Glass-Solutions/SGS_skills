---
name: "discovery-scan-orchestrator"
description: "Coordinate bounded specialist Discovery scans"
---
...
8. Show the complete numbered digest and images directly in the current task. Structure the reader-facing output as:
   ...
   Explain that Preston can invoke `$discovery-accept-proposal` with a number plus an optional note. Do not implement anything.
