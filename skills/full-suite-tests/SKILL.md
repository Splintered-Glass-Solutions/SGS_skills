...
4. Authenticated test-user setup
   ...
   - Prefer `preston@splinteredglass.solutions` as Preston's general cross-app QA identity when a project does not document a better one and the account is approved for the target environment.
