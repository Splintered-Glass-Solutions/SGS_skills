...
description: >-
  ...
  validation is proven, no approvals/blockers/follow-ups remain, and the thread
  can be marked read or returned as a ready-to-mark-read queue.
---
...
Use Codex thread tooling when available:
