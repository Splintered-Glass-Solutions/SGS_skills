...
name: save-skill
description: >-
  Save one or more local Codex skills into the private SGS_skills GitHub repo,
  including skill files, agents metadata, slash-command wrappers, portable
  playbooks, docs/index updates, validation, commit, and push. Use when Preston
  asks to save, archive, publish, commit, or push a custom skill to SGS_skills,
  or invokes the save-skill slash command for selected skill content.
---
...
Use this skill to persist Preston's custom Codex skills into
`/Users/preston/Code/SGS_skills` and push the result to GitHub. The output is a
...
- `$save-skill /Users/preston/.codex/skills/recap`
...
- Local skills root: `/Users/preston/.codex/skills`
- Local commands root: `/Users/preston/.codex/commands`
- Archive repo: `/Users/preston/Code/SGS_skills`
- Repo skills archive: `/Users/preston/Code/SGS_skills/skills`
- Repo command archive: `/Users/preston/Code/SGS_skills/commands`
- Repo skill index: `/Users/preston/Code/SGS_skills/docs/custom-skill-index.md`
- Portable generator:
  `/Users/preston/Code/SGS_skills/scripts/generate-portable-playbooks.rb`
...
2. Inspect repo state.
   - Run `git status --short --branch` in `/Users/preston/Code/SGS_skills`.
...
3. Validate local skill structure.
   ...
   - If a command wrapper exists at
     `/Users/preston/.codex/commands/<skill-name>.md`, include it.
...
- If validation fails, do not push unless Preston explicitly approves pushing a
  known-bad archive.
