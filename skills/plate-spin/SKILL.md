...
- `/Users/preston/.codex/skills/pm-project-agent/SKILL.md`
...
- approval ledger for Preston decisions
...
Preston decision needed, worker/project follow-up needed, failed/not-green
