---
name: bonfire-content-source-integration
description: Add or modify Bonfire content source integrations. Use for provider source work involving Notion, Fathom AI, Fireflies AI, Read AI, SharePoint, Google Drive, YouTube, links, provision functions, sync functions, provider credentials, content_source.config, normalized content storage, or content_process enqueueing.
---
...
Use this skill in `/Users/preston/Code/Bonfire_ETL` for first-class content source providers.
