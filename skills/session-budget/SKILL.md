---
name: session-budget
description: Use when Codex work is long, ambiguous, cross-repo, high-cost, repeatedly looping, or needs task-type budget rules; includes checkpoints for debugging, build work, planning, research/transcripts, QA/review, automation, and communication so sessions produce artifacts instead of open-ended token burn.
---

# Session Budget

Use this skill to keep Codex work bounded, useful, and reusable. The goal is not a hard token cap; it is a clear objective, right-sized context, early checkpoints, and evidence before continued iteration.
