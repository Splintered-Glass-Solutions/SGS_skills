...
# the user House Style

## Overview

Produce code that matches the user's "structured + defensive + explicit" style: clear control flow, stable error/skip codes, and predictable response shapes, with focused pytest coverage.
...
Read `references/the user_python_style.md` for copy/paste templates (handler skeletons, response envelopes, test patterns) and naming conventions.
