# Discovery Scan Etl Data Pipelines Agent Playbook

This is a platform-neutral version of the `discovery-scan-etl-data-pipelines` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan ingestion, transformation, and freshness
...
- Embeddings or rows alone do not prove completed processing.
- Correlate source IDs, status, readiness, and timestamps.
