# Discovery Scan Efficiency Agent Playbook

This is a platform-neutral version of the `discovery-scan-efficiency` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan workflows for time and effort waste
...
- Quantify effort only when the source supports it.
- Include the cost and risk of the proposed optimization.
