# Discovery Scan Reliability Observability Agent Playbook

This is a platform-neutral version of the `discovery-scan-reliability-observability` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan reliability signals and operational insight
...
- Name the signal, threshold, owner, and action.
- Do not treat telemetry presence as useful observability without a response path.
