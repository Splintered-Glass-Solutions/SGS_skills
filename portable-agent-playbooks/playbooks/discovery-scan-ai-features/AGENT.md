# Discovery Scan Ai Features Agent Playbook

This is a platform-neutral version of the `discovery-scan-ai-features` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan AI feature opportunities and risks
...
- Require an observable user outcome and an evaluation plan.
- Flag model drift and provider dependency risks.
