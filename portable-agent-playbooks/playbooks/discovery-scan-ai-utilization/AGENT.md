# Discovery Scan Ai Utilization Agent Playbook

This is a platform-neutral version of the `discovery-scan-ai-utilization` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan practical AI leverage and constraints
...
- State the human decision and verification loop.
- Include quality, privacy, latency, and cost constraints.
