# Discovery Scan Simplification Retirement Agent Playbook

This is a platform-neutral version of the `discovery-scan-simplification-retirement` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan for safe simplification and retirement
...
- Check ownership and usage before recommending removal.
- Prefer reversible deprecation steps and explicit rollback signals.
