# Discovery Scan Design Agent Playbook

This is a platform-neutral version of the `discovery-scan-design` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan product and service design quality
...
- Ground recommendations in observed flows and user goals.
- Separate usability evidence from taste or preference.
