# Discovery Scan Security Agent Playbook

This is a platform-neutral version of the `discovery-scan-security` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan security controls and attack surfaces
...
- Never retain secrets or exploit payloads in findings.
- Distinguish design weakness, observed exposure, and unverified risk.
