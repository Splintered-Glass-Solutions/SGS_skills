# Discovery Scan Accessibility Agent Playbook

This is a platform-neutral version of the `discovery-scan-accessibility` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan inclusive access and interaction
...
- Report the affected user task and barrier.
- Distinguish automated signal from human or assistive-tech verification.
