# Discovery Scan Developer Experience Agent Playbook

This is a platform-neutral version of the `discovery-scan-developer-experience` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan developer workflows and feedback loops
...
- Use reproducible steps and repository evidence.
- Separate local convenience from team-scale reliability.
