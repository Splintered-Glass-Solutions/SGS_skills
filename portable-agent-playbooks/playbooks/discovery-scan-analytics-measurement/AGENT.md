# Discovery Scan Analytics Measurement Agent Playbook

This is a platform-neutral version of the `discovery-scan-analytics-measurement` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan metrics, instrumentation, and decisions
...
- Name the metric definition and source of truth.
- Treat missing instrumentation as an abstention from causal claims.
