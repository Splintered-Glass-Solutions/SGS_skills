# Artifact Template Sgs Refined Proposal Microsite Agent Playbook

This is a platform-neutral version of the `artifact-template-sgs-refined-proposal-microsite` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Create a Site using the SGS Refined Proposal Microsite template and its retained source directory. Use when the user selects this template, names SGS Refined Proposal Microsite, or explicitly invokes $artifact-template-sgs-refined-proposal-microsite. Create client proposal microsites with the refined SGS layout: front-loaded value, icon-led cards, three pacing options, a highlighted recommendation, and responsive mobile behavior.
