# Discovery Scan Api Architecture Agent Playbook

This is a platform-neutral version of the `discovery-scan-api-architecture` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan API contracts and service boundaries
...
- Trace caller, provider, payload, and state transitions.
- Treat undocumented behavior as uncertainty until observed.
