# Discovery Scan Performance Agent Playbook

This is a platform-neutral version of the `discovery-scan-performance` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan latency, throughput, and resource use
...
- Use measured traces or clearly label hypotheses.
- Include the user-visible and cost impact of optimization work.
