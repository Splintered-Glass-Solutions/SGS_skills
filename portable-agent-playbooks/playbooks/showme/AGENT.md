# Showme Agent Playbook

This is a platform-neutral version of the `showme` skill. It is designed
...
this general skill and may be maintained in the agent project configuration; do not
