# Discovery Scan Cost Infrastructure Agent Playbook

This is a platform-neutral version of the `discovery-scan-cost-infrastructure` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan infrastructure cost and capacity
...
- Use current billing or resource evidence when available.
- Include reliability and security tradeoffs in cost proposals.
