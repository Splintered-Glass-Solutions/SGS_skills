# Bonfire Chat Widget Agent Playbook

This is a platform-neutral version of the `bonfire-chat-widget` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Work on Bonfire's embeddable chat widget, widget preview, public chat APIs, streaming UI, widget build, mobile widget behavior, cross-origin embed behavior, or files under src/features/chat-widget, src/app/widget, public/widget.js, or src/app/api/chat.
...
Use this skill for Bonfire widget changes in `<workspace>/bonfire`.
...
For production widget outage or deploy verification, run the Session API streamed smoke from `<workspace>/Bonfire_AI` against both the direct Session API and the app proxy when applicable:
