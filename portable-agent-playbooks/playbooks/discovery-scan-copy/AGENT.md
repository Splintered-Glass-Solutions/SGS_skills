# Discovery Scan Copy Agent Playbook

This is a platform-neutral version of the `discovery-scan-copy` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan product language for clarity and trust
...
- Preserve exact claims boundaries and avoid inventing benefits.
- Prefer specific, testable language over marketing filler.
