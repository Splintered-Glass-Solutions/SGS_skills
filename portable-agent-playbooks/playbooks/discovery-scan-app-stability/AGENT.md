# Discovery Scan App Stability Agent Playbook

This is a platform-neutral version of the `discovery-scan-app-stability` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan runtime stability and failure recovery
...
- Separate terminal failure from blocked or untested behavior.
- Record the exact reproduction boundary when available.
