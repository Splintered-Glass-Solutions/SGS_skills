...
3. Create the local asset package.
   ...
   - For cross-repo or non-repo work, use `/Users/the user/Marketing Assets/Bonfire/` unless the user names another folder.
...
```bash
python3 <agent-config>/skills/marketing-asset-generation/scripts/create_marketing_asset_package.py \
...
```bash
python3 <agent-config>/skills/marketing-asset-generation/scripts/find_marketing_asset_package.py \
  --feature-name "Agent Font Size Options"
```
