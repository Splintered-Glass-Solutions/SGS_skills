...
```bash
python3 <agent-config>/skills/looker-dashboard-diagnostics/scripts/extract_dashboard.py \
  --dashboard 254 \
...
For Fabric-specific work in `<workspace>/fabric_ai`, compare extracted Looker metadata against:
