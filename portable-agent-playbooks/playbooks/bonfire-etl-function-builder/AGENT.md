# Bonfire Etl Function Builder Agent Playbook

This is a platform-neutral version of the `bonfire-etl-function-builder` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Build, modify, or review Bonfire ETL Lambda function folders. Use when working on Bonfire_ETL functions, function.yaml files, Lambda handlers, SQS/webhook contracts, Dockerfiles, per-function tests, or shared bonfire_etl_shared helpers.
...
Use this skill in `<workspace>/Bonfire_ETL` when creating or changing a deployable ETL function under `functions/`.
