# Discovery Scan Privacy Trust Agent Playbook

This is a platform-neutral version of the `discovery-scan-privacy-trust` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan privacy promises and trust boundaries
...
- Keep personal and customer data out of durable findings.
- Separate documented promise, implementation evidence, and legal interpretation.
