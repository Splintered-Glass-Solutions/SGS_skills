# Discovery Scan Marketing Branding Agent Playbook

This is a platform-neutral version of the `discovery-scan-marketing-branding` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan brand, positioning, and growth surfaces
...
- Keep audience claims tied to evidence.
- Separate brand coherence from subjective preference.
