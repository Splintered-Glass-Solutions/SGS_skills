# Discovery Scan Product Strategy Agent Playbook

This is a platform-neutral version of the `discovery-scan-product-strategy` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan product direction and strategic fit
...
- Keep strategy claims proportional to evidence.
- Name what to stop, defer, or learn before committing.
