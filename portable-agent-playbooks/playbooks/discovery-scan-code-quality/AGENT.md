# Discovery Scan Code Quality Agent Playbook

This is a platform-neutral version of the `discovery-scan-code-quality` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan maintainability and implementation quality
...
- Do not promote style preferences to defects without impact evidence.
