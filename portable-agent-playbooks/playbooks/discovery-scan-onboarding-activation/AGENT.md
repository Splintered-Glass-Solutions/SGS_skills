# Discovery Scan Onboarding Activation Agent Playbook

This is a platform-neutral version of the `discovery-scan-onboarding-activation` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan onboarding and activation friction
...
- Define the actor and activation event precisely.
- Do not infer conversion impact without measurement evidence.
