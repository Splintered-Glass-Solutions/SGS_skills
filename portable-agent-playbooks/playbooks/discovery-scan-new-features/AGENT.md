# Discovery Scan New Features Agent Playbook

This is a platform-neutral version of the `discovery-scan-new-features` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan for validated new product capabilities
...
- Start with a problem and evidence, not a solution label.
- Mark speculative ideas as hypotheses, not commitments.
