# Discovery Scan Uiux Agent Playbook

This is a platform-neutral version of the `discovery-scan-uiux` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan UI and UX friction across flows
...
- Name the actor, task, state, and observed friction.
- Use screenshots or route references only when they are safe and durable.
