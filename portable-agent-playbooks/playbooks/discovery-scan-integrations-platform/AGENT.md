# Discovery Scan Integrations Platform Agent Playbook

This is a platform-neutral version of the `discovery-scan-integrations-platform` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan integration seams and platform fit
...
- Verify the exact provider and environment before conclusions.
- Record integration assumptions as explicit dependencies.
