# Discovery Scan Database Agent Playbook

This is a platform-neutral version of the `discovery-scan-database` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Scan data models, queries, and integrity
...
- Do not infer applied state from files alone.
- Separate schema risk from live data evidence.
