# Striq Clickup Agent Playbook

This is a platform-neutral version of the `striq-clickup` skill. It is designed
for use with Claude, Claude Code, Cursor, OpenAI agents, or another agent
platform that supports reusable instructions.

## Trigger

Use when doing StrIQ work or creating ClickUp tasks for StrIQ-related repos, including striq-backend, striq-api, ios-striq, frontend, and striq-shared-docs. Provides StrIQ's ClickUp workspace, list, status semantics, priority, the user/Austin assignee routing, and task intake workflow.
...
- Assign the user (`12890094`) for AI, data methodology, data quality, analytics, cost analysis, customer-facing data investigations, or any task the user says should be tagged to "me" or "the user".
