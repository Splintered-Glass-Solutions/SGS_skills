---
description: "Run Discovery: scan analytics measurement against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-analytics-measurement/SKILL.md.
