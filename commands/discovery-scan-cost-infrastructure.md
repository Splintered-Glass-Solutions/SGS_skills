---
description: "Run Discovery: scan cost infrastructure against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-cost-infrastructure/SKILL.md.
