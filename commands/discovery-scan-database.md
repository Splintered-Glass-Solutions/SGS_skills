---
description: "Run Discovery: scan database against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-database/SKILL.md.
