---
description: "Run Discovery: scan simplification retirement against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-simplification-retirement/SKILL.md.
