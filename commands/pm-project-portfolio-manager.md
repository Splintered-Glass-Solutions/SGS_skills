...
4. Read `/Users/preston/.codex/portfolio/approval-schema.md`.
5. Read `/Users/preston/.codex/portfolio/delegation-watchlist.md` when delegation follow-through is in scope.
6. Read `/Users/preston/.codex/portfolio/pm-ledger-clickup-model.md`.
7. Read `/Users/preston/.codex/skills/pm-project-agent/SKILL.md` when the scope involves Project Agent threads.
...
- Dispatcher scorecards must separate activity from outcome movement: blockers removed, Preston decisions reduced, delegated tasks completed, stale projects revived, false-positive delegations, unread threads cleared safely, and comms items converted to tasks.
- When approval entries change, run `/Users/preston/.codex/portfolio/scripts/validate-approval-ledger.mjs`.
- Show exact Preston decisions blocking motion from `current-state.approvals.blocking_decisions`.
