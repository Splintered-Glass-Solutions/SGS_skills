---
description: "Run Discovery: scan integrations platform against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-integrations-platform/SKILL.md.
