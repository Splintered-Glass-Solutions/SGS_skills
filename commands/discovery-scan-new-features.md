---
description: "Run Discovery: scan new features against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-new-features/SKILL.md.
