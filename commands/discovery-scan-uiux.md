---
description: "Run Discovery: scan uiux against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-uiux/SKILL.md.
