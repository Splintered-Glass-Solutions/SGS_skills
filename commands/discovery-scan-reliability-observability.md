---
description: "Run Discovery: scan reliability observability against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-reliability-observability/SKILL.md.
