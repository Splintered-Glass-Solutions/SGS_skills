---
description: "Run Discovery: scan api architecture against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-api-architecture/SKILL.md.
