---
description: "Run Discovery: scan product strategy against the project where this command is invoked."
...
1. Read and follow the local skill at $CODEX_HOME/skills/discovery-scan-product-strategy/SKILL.md.
