...
The local catalog contains private project adapters and personal operating
preferences. A portable or public archive should contain only generalized
workflows with secrets, private paths, customer data, and project-specific
registries removed.
